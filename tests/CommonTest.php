    ...
    public static function setupBeforeClass()
    {
        ...
        $structure->setInitializer(
            function () use ($structure) {
                ...
                $classNode1->setPathProcessor(
                    function ($remainingPath, array &$pathData) use ($structure) {
                ...
                $notProcessingNode->setPathTrigger(
                    function ($remainingPath) {
                ...
                $idNode->setTag('id');
                $idNode->setPathTrigger(
                    function ($remainingPath) use ($structure) {
